...
export function WhatsAppFAB() {
    ...
    // Hide when cart or search modal is open
    if (isCartOpen || isSearchOpen) return null;

    const whatsappUrl = `https://wa.me/${contactSettings.whatsapp_number}`;
    ...
    return (
        ...
        >
            ...
            <span className="hidden xs:inline">{t('float_label')}</span>
        </motion.a>
    );
}
