...
export function Footer({ locale }: FooterProps) {
    ...
    return (
        <footer className="bg-gradient-dark text-purple-200 dark:text-purple-200 pt-12 pb-6 mt-16">
            <div className="container mx-auto px-4">
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 mb-10">
                    ...
                    <div className="lg:col-span-2">
                        ...
                        <p className="text-purple-300 dark:text-purple-300 text-sm leading-relaxed max-w-xs">
                        ...
                        <a
                            ...
                            className="inline-flex items-center gap-2 mt-4 px-4 py-2 rounded-full bg-[#25D366] text-white dark:text-white text-sm font-medium hover:bg-[#128C7E] transition-colors"
                        >
                    ...
                    <div>
                        ...
                        <ul className="space-y-2">
                            {quickLinks.map(link => (
                                <li key={link.href}>
                                    <Link href={link.href} className="text-purple-300 dark:text-purple-300 hover:text-gold-400 text-sm transition-colors">
                                        {link.label}
                                    </Link>
                                </li>
                            ))}
                            ...
                            <div className="mt-6">
                                ...
                                <div className="flex gap-3">
                                    {contactSettings.social_links.instagram && (
                                        <a href={contactSettings.social_links.instagram} target="_blank" rel="noopener noreferrer" className="text-purple-300 dark:text-purple-300 hover:text-gold-400 transition-colors" aria-label="Instagram">
