...
export function Footer({ locale }: FooterProps) {
    ...
    return (
        <footer className="bg-gradient-dark text-purple-100 dark:text-purple-100 pt-12 pb-6 mt-16">
            <div className="container mx-auto px-4">
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 mb-10">
                    ...
                    <div className="lg:col-span-2">
                        ...
                        <p className="text-purple-200 dark:text-purple-200 text-sm leading-relaxed max-w-xs">
                    ...
                    <div>
                        ...
                        <ul className="space-y-2">
                            {quickLinks.map(link => (
                                <li key={link.href}>
                                    <Link href={link.href} className="text-purple-200 dark:text-purple-200 hover:text-gold-400 text-sm transition-colors">
                                        {link.label}
                                    </Link>
                                </li>
                            ))}
                            ...
                            <div className="mt-6">
                                ...
                                <div className="flex gap-3">
                                    {contactSettings.social_links.instagram && (
                                        <a href={contactSettings.social_links.instagram} target="_blank" rel="noopener noreferrer" className="text-purple-200 dark:text-purple-200 hover:text-gold-400 transition-colors" aria-label="Instagram">
                ...
                <div className="border-t border-purple-800/50 pt-6 text-center text-xs text-purple-300 dark:text-purple-300">
