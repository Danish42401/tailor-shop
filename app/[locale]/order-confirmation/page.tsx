    ...
    return (
        <div className="container mx-auto px-4 py-16 text-center">
            <div className="max-w-md mx-auto">
                {/* Success icon */}
                <div className="w-24 h-24 rounded-full bg-gradient-luxury flex items-center justify-center mx-auto mb-6 shadow-luxury">
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                    ...
                    <a
                        ...
                        className="inline-flex items-center justify-center gap-2 px-6 py-3 rounded-xl bg-[#25D366] text-white font-semibold hover:bg-[#128C7E] transition-colors"
                    >
                        ...
                        {t('order_confirmation.contact_us')}
                    </a>
                </div>
            </div>
        </div>
