...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    "product.size_error": "Please select a size to proceed",
    "product.custom_size": "Custom Size",
    "product.size_label": "Size",
    "cart.title": "Your Selection",
    "cart.empty": "Selection is empty",
    "cart.total": "Estimated Total",
    "cart.total_request": "Price Enquired on WhatsApp",
    ...
    "summary.custom_for": "Custom order for",
